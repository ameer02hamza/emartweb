...
import { cardType, categoryType } from "@/interfaces/emart/card.type";
import {
  FaShippingFast,
  FaNodeJs,
  FaHtml5,
...
export const cardCatList: categoryType[] = [
  {
    title: "Men",
    imageUrl:
      "https://manofmany.com/_next/image?url=https%3A%2F%2Fapi.manofmany.com%2Fwp-content%2Fuploads%2F2023%2F05%2FLounge-Suit-Dress-Code-Guide-for-Men.jpg&w=1200&q=75",
  },
  {
    title: "Women",
    imageUrl:
      "https://sitarastudio.pk/cdn/shop/articles/87_3.webp?v=1707206116",
  },
  {
    title: "Kids",
    imageUrl:
      "https://cdn.bfab.com/_next/image?url=https%3A%2F%2Fadmin.bfab.me%2Fmedia%2Fimg%2FGroup%2062623mob.png&w=3840&q=90",
  },
];
