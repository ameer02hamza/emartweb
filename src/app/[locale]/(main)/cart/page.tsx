...
import { RootState } from "@/redux/emart-redux/store/store";
import { ProductsType } from "@/interfaces/emart/product.type";
import {
  addToCart,
  removeFromCart,
  removeProduct,
} from "@/redux/emart-redux/features/cart/cartSlice";
import Modal from "@/components/emart-component/modal.component";
import { imgEmptyCart } from "@/consts/emart/images.const";
import withAuthentication from "@/components/emart-component/higherordercomponents/authvalidator.hoc";
import { productType } from "@/interfaces/emart/card.type";
