...
import InputFormField from "@/components/emart-component/inputfield.compnent";
import LoadingSpinner from "@/components/emart-component/loadingspinner.component";
import { thunkStatus } from "@/consts/emart/const.values";
import { imgAuthBanner } from "@/consts/emart/images.const";
import { LoginType } from "@/interfaces/emart/auth.type";
import { loginThunk } from "@/redux/emart-redux/features/auth/auth.thunk";
...
function LoginPage() {
  ...
  useEffect(() => {
    ...
    console.log(loginState.authResponse);
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        ...
        <div className="flex-1  text-center hidden lg:flex">
          <div
            className="m-12 xl:m-16 w-full bg-contain bg-center bg-repeat"
            style={{
              backgroundImage: `url(${imgAuthBanner})`,
            }}
          ></div>
        </div>
      </div>
